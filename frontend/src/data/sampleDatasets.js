/**
 * Pre-configured Enterprise Datasets for Demo & Hackathon Evaluation.
 * 
 * 1. CLEAN_DATASET: 10 transactions, 100% matched, demonstrates baseline flow.
 * 2. EXCEPTION_DATASET: 50 transactions, contains:
 *    - 6 Missing in Bank File (Ghost gateway charges)
 *    - 6 Missing in ERP Ledger (Unrecorded settlements)
 *    - 2 Amount Mismatches beyond fee tolerance (₹1,200 & ₹700 variance)
 *    - 8 Reference ID Drifts (gateway vs bank format differences)
 *    - 6 Settlement Timing Lags (3-5 day clearing delay)
 *    - 2 Refund / Chargeback Reversals
 */

export const CLEAN_DATASET = {
  gateway: `payment_id,order_id,amount,fee,tax,status,timestamp,payment_method,card_network
...
pay_RZP_010,order_RZP_010,5300.00,125.08,19.08,SUCCESS,2024-02-10T14:10:00Z,card,Visa`,
  ...
  bank: `utr_number,reference_note,settled_amount,settlement_date,bank_name
...
UTR9821010,SET-RZP-010,5174.92,2024-02-12T00:00:00Z,HDFC Bank`,
  ...
  ledger: `voucher_no,order_ref,amount,status,date,account_head
...
export const EXCEPTION_DATASET = {
  gateway: `payment_id,order_id,amount,fee,tax,status,timestamp,payment_method,card_network
pay_RZP_001,order_RZP_001,1500.00,35.40,5.40,SUCCESS,2024-02-10T09:15:00Z,card,Visa
pay_RZP_002,order_RZP_002,4500.00,106.20,16.20,SUCCESS,2024-02-10T09:22:00Z,upi,UPI
pay_RZP_003,order_RZP_003,890.00,20.98,3.20,SUCCESS,2024-02-10T09:40:00Z,netbanking,HDFC
